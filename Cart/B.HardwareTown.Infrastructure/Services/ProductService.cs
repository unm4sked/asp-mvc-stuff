	...
	public class ProductService : IProductService
	{
		...
		public ProductDTO Get(string name)
		{
			...
			return new ProductDTO
			{
				...
				UsersWhoLiked = product.UsersWhoLiked
			};
		}
		...
		public async Task< IEnumerable<ProductDTO>> GetOneCategoriesProductsDTOAsync(string categoryName)
		{
			List<ProductDTO> _productDTOs = new List<ProductDTO>();
			foreach (var p in _productRepository.GetAll())
			{
			...
			_productDTOs = _productDTOs.Where(x => x.Categoryname == categoryName).ToList();
			var productDTOs = await Task.Run(() => _productDTOs);
			return productDTOs;
		}
	}
